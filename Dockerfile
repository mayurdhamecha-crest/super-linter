...
FROM python:3.14.0a3-alpine3.20 AS clang-format
...
FROM python:3.14.0a3-alpine3.20 AS python-builder
...
FROM python:3.14.0a3-alpine3.20 AS npm-builder
...
FROM python:3.14.0a3-alpine3.20 AS lintr-installer
...
FROM python:3.14.0a3-alpine3.20 AS base_image
